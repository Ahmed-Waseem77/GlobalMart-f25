...
This script creates dimension and fact collections in MongoDB for the ELT pipeline.
...
The collections use JSON Schema validation to enforce data structure.
...
# Using replica set connection string for high availability
    ...
    dim_time_validator = {
        "$jsonSchema": {
            ...
            "properties": {
                "time_id": {
                    "bsonType": "string",
                    "description": "Unique time identifier (YYYYMMDDHH format)"
                },
                "year": {
                    "bsonType": "int",
                    "description": "Year"
    ...
    fact_transactions_validator = {
        "$jsonSchema": {
            ...
            "properties": {
                ...
                "user_id": {
                    "bsonType": "string",
                    "description": "Reference to dim_users"
                },
                "time_id": {
                    "bsonType": "string",
                ...
                "products": {
                    "bsonType": "array",
                    "description": "Array of products in transaction",
                    "items": {
                        "bsonType": "object",
                        "properties": {
                            "product_id": {
    ...
    fact_sessions_validator = {
        "$jsonSchema": {
            ...
            "properties": {
                ...
                "events": {
                    "bsonType": "array",
                    "description": "Array of events in session",
                    "items": {
                        "bsonType": "object",
                        "properties": {
                            "event_type": {
...
def main():
    ...
    print("=" * 60)
    print("MongoDB Star Schema Creation for GlobalMart")
    print("=" * 60)
