...
def generate_user():
    ...
    countries = ["Egypt", "Russia", "China", "Italy","Mongolia","Brazil", "Eswatini", "Timor-Leste", "Cambodia", "Federated States of Micronesia"]
...
def generate_session():
    ...
    if random.random() < ANOMALY_RATE:
        # Anomaly: Too many events in a short time (Bot attack)
